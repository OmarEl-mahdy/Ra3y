...
public class registerSitter extends AppCompatActivity {
    ...
    String fname, Lname,E,PNumber,pass, yoe, pricephour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText years = (EditText) findViewById(R.id.yearsofexperience);
        EditText priceph = (EditText) findViewById(R.id.priceperhour);
        ...
        signupbutton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                yoe = years.getText().toString().trim();
                pricephour = priceph.getText().toString().trim();
    ...
    private class API_handler extends AsyncTask<String,String,String>{
        ...
        private void registerSitter(){
            //"""This method is responsible for setting adding user of type sitter to the database"""
            Log.d("HEREregister sitter", "HEREEEE");
            HttpURLConnection connection = null;
            BufferedReader reader = null;
            try {
                URL url = new URL("http://"+DeviceIP+":"+portNo+"/registerSitter");
                ...
                Log.d("yearsOfExperience",yoe);
                Log.d("priceperhour",pricephour);
                ...
                dataTosend.put("yearsOfExperience",yoe);
                dataTosend.put("priceperhour",pricephour);
