...
public final class ActivitySittersListBinding implements ViewBinding {
  ...
  private ActivitySittersListBinding(@NonNull RelativeLayout rootView, @NonNull ListView list,
  ...
  public static ActivitySittersListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySittersListBinding((RelativeLayout) rootView, list, sList,
          sittersListTitle);
    }
